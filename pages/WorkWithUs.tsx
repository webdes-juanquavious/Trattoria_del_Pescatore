...
const translations = {
  it: {
    ...
    apply: 'Candidati',
    applyMsg: 'Salve, mi vorrei candidare alla offerta di lavoro',
    fullTime: 'Full-time',
    partTime: 'Part-time',
    seasonal: 'Stagionale',
    remote: 'Remote',
  ...
  en: {
    ...
    apply: 'Apply',
    applyMsg: 'Hello, I would like to apply for the job offer',
    fullTime: 'Full-time',
    partTime: 'Part-time',
    seasonal: 'Seasonal',
    remote: 'Remote',
  ...
  fr: {
    ...
    apply: 'Postuler',
    applyMsg: 'Bonjour, je souhaite postuler à l\'offre d\'emploi',
  ...
  es: {
    ...
    apply: 'Postúlate',
    applyMsg: 'Hola, me gustaría postularme para la oferta de trabajo',
  ...
  de: {
    ...
    apply: 'Bewerben',
    applyMsg: 'Hallo, ich möchte mich auf das Stellenangebot bewerben',
    fullTime: 'Vollzeit',
    partTime: 'Teilzeit',
    seasonal: 'Saisonal',
    remote: 'Remote',
  ...
  ar: {
    ...
    apply: 'تقدم',
    applyMsg: 'مرحبًا، أود التقدم للوظيفة',
    fullTime: 'دوام كامل',
    partTime: 'دوام جزئي',
    seasonal: 'موسمي',
    remote: 'عن بعد',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {jobs.map(job => (
            <div key={job.id} className="relative bg-white/5 border border-white/10 rounded-2xl shadow-xl flex flex-col p-8 pb-6 min-h-[340px] group hover:shadow-2xl transition-all">
              ...
              {/* Pulsante Candidati */}
              <a
                href={`https://wa.me/?text=${encodeURIComponent(`${t.applyMsg} ${job.title}`)}`}
                target="_blank"
