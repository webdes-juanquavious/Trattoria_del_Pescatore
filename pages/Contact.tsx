                ...
                {meta.Social_facebook && (
                  <a href={meta.Social_facebook} target="_blank" rel="noopener noreferrer" className="flex items-start space-x-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-restaurant-subtext group-hover:text-restaurant-accent transition-colors">{meta.Social_facebook.split('/').pop()}</p>
                    </div>
                  </a>
                )}
                {meta.Social_instagram && (
                  <a href={meta.Social_instagram} target="_blank" rel="noopener noreferrer" className="flex items-start space-x-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-restaurant-subtext group-hover:text-restaurant-accent transition-colors">@{meta.Social_instagram.split('/').pop()}</p>
                    </div>
                  </a>
                )}
                {meta.Social_tiktok && (
                  <a href={meta.Social_tiktok} target="_blank" rel="noopener noreferrer" className="flex items-start space-x-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-restaurant-subtext group-hover:text-restaurant-accent transition-colors">{meta.Social_tiktok.split('/').pop()}</p>
                    </div>
                  </a>
                )}
                {meta.Social_twitter && (
                  <a href={meta.Social_twitter} target="_blank" rel="noopener noreferrer" className="flex items-start space-x-4 group">
                    ...
                    <div>
                      ...
                      <p className="text-restaurant-subtext group-hover:text-restaurant-accent transition-colors">@{meta.Social_twitter.split('/').pop()}</p>
                    </div>
                  </a>
                )}
              </div>
                  ...
                  if (typeof value === 'string' && value.startsWith('http')) {
                    ...
                    return (
                      <a key={key} href={value} target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 group">
                        ...
                        <p className="text-restaurant-subtext group-hover:text-restaurant-accent transition-colors">{value}</p>
                      </a>
                    );
                  }
                  return null;
